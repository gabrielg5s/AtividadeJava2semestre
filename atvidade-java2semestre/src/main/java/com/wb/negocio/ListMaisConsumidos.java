...
public class ListMaisConsumidos extends Listagem {
    private List<Produto> produtos;
    private List<Consumo> consumos;

    public ListMaisConsumidos(List<Produto> produtos, List<Consumo> consumos) {
                    ...
                    for(ConsumoProduto cP : consumosProdutos) 
                        {
                            ...
                            System.out.println("Total de Produtos Consumidos: " + cP.qantConsumo);
                            c++;
                        }
                } 
            else {
