...
public class ListAllClientes extends Listagem {
	private List<Cliente> clientes;
	private PrintCliente impressao;

	public ListAllClientes(List<Cliente> clientes) {
			...
			switch (operacao) 
				{
					...
					case 4:
						...
						Listagem listar5 = new ListCinco(clientes);
						listar5.listar();
						return;
					case 5:
						System.out.println("\n➕ 10 clientes que mais consumiram produtos ou serviços.");
						Listagem listar10Mais = new ListDezMaisConsumo(clientes);
						listar10Mais.listar();
						return;
					case 6:
						System.out.println("\n➖ 10 clientes que menos consumiram produtos ou serviços.");
						Listagem listar10Menos = new ListDezMenosConsumo(clientes);
