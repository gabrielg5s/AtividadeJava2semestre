...
public class ListAllProdutos extends Listagem 
	{
		private List<Produto> produtos;
		private List<Consumo> consumos;

		public ListAllProdutos(List<Produto> produtos, List<Consumo> consumos) 
			{
		...
		public void listar() 
			{
				...
				System.out.println("4- Mais consumidos");
				System.out.print("\nO que deseja fazer? ");
				...
				switch (operacao) 
					{
						...
						case 4:
							...
							Listagem listaMaisConsumidos = new ListMaisConsumidos(produtos, consumos);
